...
const movies= paginate(allMovies,currentPage,pageSize)
  ...
  <div className="container">
    <div className="row">
    <div className="col-3">
<ListGroup items={this.state.genre} genreOnSelect={this.handleGenreSelection}/>
</div>
    <div className="col-8">
...
<Pagination itemSize={count}  pageSize= {pageSize} pageOnChange={this.handleChange} currentPage={currentPage}/>
  </div>
